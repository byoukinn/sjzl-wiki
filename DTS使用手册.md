...
![更新模式](DTS使用手册.assets/3I8%H7[JJPX@YMLH8CSPR_C.png)
...
### 8.17 DTS能到登录界面但是输入账号密码后却有报错
<details>
<summary>DTS按照升级文档更新后能到登录界面但是输入账号密码后却有报错，请在mongoDB数据库下，新建查询执行以下四段SQL</summary>
...
此时我们尝试通过数据库工具连入该数据库，并尝试插入一条数据进入到表，以查看报错
